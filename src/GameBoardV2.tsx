          ...
          <Modal
            title={
              state.gameState === 'start'
                ? 'Welcome to the ⚡ The Electric Co. ⚡'
                : 'Game Over'
            }
            message={
              state.gameState === 'start'
                ? 'Instructions: Place pieces to manage the energy flow. Avoid outages and negative scores.'
                : 'You lost! You had over 100 outages or a score below -2000.'
            }
            onClose={closeModal}
          />
        )}
